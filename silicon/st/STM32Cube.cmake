...
if ((${STM32_DEVICE} STREQUAL "STM32F031x6") OR
    ...
    set(st_CMSIS_DIR "${cube${LOWERCASE_STM32_TYPE}_SOURCE_DIR}/Drivers/CMSIS" CACHE PATH "Path to STM32CubeXX CMSIS folder")
    set(st_HAL_Driver_DIR "${cube${LOWERCASE_STM32_TYPE}_SOURCE_DIR}/Drivers/STM32${UPPERCASE_STM32_TYPE}xx_HAL_Driver" CACHE PATH "Path to STM32CubeXX Drivers folder")
